...
import BrazilStates from "../mock/states.json"
...
export const COFFEES_UF_STORAGE_KEY = "@coffee-delivery:coffess-uff-value-1.0.0"
    ...
    if (coords) {
      ...
      fetch(
        ...
        response.json().then((data: APIResponse) => {
          const state =
            BrazilStates[data.principalSubdivision as keyof typeof BrazilStates]
